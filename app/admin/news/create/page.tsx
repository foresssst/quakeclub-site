    ...
    <div className="relative min-h-screen bg-black">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div className="mx-auto w-full max-w-4xl flex-1 px-6 py-8">
          <div className="mb-8">
            <h1 className="mb-2 text-3xl font-bold text-white">Nueva Noticia</h1>
            <p className="font-roboto text-gray-400">Crea una nueva noticia con soporte para Markdown</p>
          </div>
